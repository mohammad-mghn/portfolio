    ...
    <section className="flex flex-col items-center justify-between py-6 lg:flex-row gap-y-14">
      <div className="flex flex-col justify-center py-16">
        ...
        <p className="mt-2 max-w-[18rem] md:max-w-[25rem] text-text text-sm md:text-xl leading-relaxed opacity-90">
          In which I’m really passionate in learning and coding. in which I’m really passionate in learning and coding.
          learning and coding.
        </p>
        <div className="flex items-center mt-5 gap-x-4">
          ...
          <button className={`px-3 py-2 md:px-5 md:py-3 text-text text-sm md:text-[1.125rem] font-semibold`}>
            Get in touch
          </button>
        </div>
      </div>
