  ...
  return (
    <>
      <div className={styles.home_container}>
        <Header title="Vito Mohagheghian" description="vito mohagheghian portfolio and blog" />
        <main className={styles.container}>
          <div className={styles.main_container}>
            ...
            <h2 className={styles.description} translate="yes">
              I&apos;m a JavaScript and React.js developer, and UI designer with short but effectual experience.
            </h2>
            <Button
              text="About"
              href="/about"
          ...
          <div className={styles.sidebar} data-number="Jun 20, 2020">
            <img src={AllInOne.src} alt="vito mohagheghian informations" className={styles.allione} />
          </div>
        </main>
      </div>
    </>
