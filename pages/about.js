...
const About = () => {
  ...
  return (
    <>
      <Header title="Vito Mohagheghian • About" description="Vito mohagheghian's autobiography and skills" />
      ...
      <AnimatePresence>
        <main className={styles.container}>
          <section className={styles.cover}>
            ...
            <Image src={AboutLandingImage} height={500} width={500} alt="About illustration" />
            <div
              onClick={() => {
          ...
          <motion.div initial="offscreen" whileInView="onscreen" exit="exit" viewport={{ amount: 0.4 }}>
            <section className={styles.biography_and_details}>
              ...
              <div className={styles.horizantal_line} style={{ height: "85%" }}></div>
              <div className={styles.biography_details}>
                <motion.div variants={Variants}>
                  ...
                  <div className={styles.details_child}>
                    ...
                    <h2 className={styles.details_child_text}>Esfahan, Iran, Asia, Earth</h2>
                  </div>
                  <div className={styles.details_child}>
