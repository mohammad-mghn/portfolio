...
export const projects: project[] = [
  ...
  },
  {
    ...
    description: `Mini project for start learning NextJs tried to implement details. so I didn't use best practices.
    
    the image is not clone environment.
    `,
    links: [
      {
        icon: WebIcon,
        link: "https://vito-instagram-clone.vercel.app",
      },
      {
        icon: GithubIcon,
