...
export const testimonials: testimonialType[] = [
  ...
  {
    name: "Ami Mahdi Shad - Junior Front-end Dev",
    link: "https://mega.nz/file/Yp10BCxJ#itIJUlElmmfvqWSgfAXLkn2vXlLaxVRH5zZRGfmovGU",
    socialMedia: "Resume",
    text: `Continuous interactions with Mohammad provided me with a golden opportunity to gain deeper insights into Frontend development techniques. As a perfectionist, he showcases an emphasis on details in all aspects of the project, guiding the entire team towards continuous improvement. I thoroughly enjoyed collaborating with Mohammad and this experience provided me with an excellent chance to enhance my skills in Frontend development and perfectionist thinking.`,
  },
];
